    ...
    public void execute() {
        ...
        try {
            ...
            if (scanner.nextLine().toLowerCase().equals("y")) {
                ...
                newsDtoRequest = new NewsDtoRequest(Long.parseLong(id), title, content,
                        Long.parseLong(authorId), tagIdList);
            } else {
                newsDtoRequest = new NewsDtoRequest(Long.parseLong(id), title, content, Long.parseLong(authorId));
            }
