...
@Component
public class GetTagByIdCommand implements MenuCommands {
    private final BaseController<TagDtoRequest, TagDtoResponse, Long> tagController;
    private final Scanner scanner;

    public GetTagByIdCommand(BaseController<TagDtoRequest, TagDtoResponse, Long> tagController) {
    ...
    @Override
    public void execute() {
        System.out.println(OPERATION.getText() + MenuOptions.GET_TAG_BY_ID.getOptionName());
        ...
        try {
            ...
            System.out.println(tagController.readById(Long.parseLong(id)));
